...
public interface MaterialInventoryService {
	ResponseEntity<Object> getMaterialInventory(UserInfo userInfo) throws Exception;
	...
	public ResponseEntity<Object> getMaterialInventoryLinkMaster(Map<String, Object> inputMap, final UserInfo objUserInfo)
			throws Exception;
