...
public interface ManufacturerDAO {
	 ...
	 * manufacturer(s) and their associated details (Manufacturer Site details and
	 * Manufacturer Contacts details)
	 * 
	...
	public ManufacturerContactInfo getContactManufacturerById(final int nmanufCode, final int nmanufSiteCode,
			final int nmanufContactCode) throws Exception;
	 ...
	 * @throws Exception that are thrown in the DAO layer
	 */
	public ResponseEntity<Object> getManufacturerWithSiteAndContactDetails(final UserInfo userInfo, final int nmanufcode)
			throws Exception;
	...
	public List<ManufacturerSiteAddress> getManufacturerSiteDetailsById(final UserInfo userInfo, final int nmanufcode,
			int nmanufsitecode) throws Exception;
	/**
	 * This interface declaration is used to retrieve list of all active
	 * manufacturer contact details based on the site
	 * 
	 * @param nmanufcode     [int] primary key of site object for which the list is
	 *                       to be fetched
	 * @param nmanufSiteCode [int] primary key of site object for which the list is
	 ...
	 * @throws Exception that are thrown in the DAO layer
	 */
	public ResponseEntity<Object> createManufacturer(Map<String, Object> inputMap,final  UserInfo userInfo) throws Exception;
	 ...
	 * @throws Exception that are thrown in the DAO layer
	 */
	public ResponseEntity<Object> updateManufacturer(final Manufacturer manufacturer,final  UserInfo userInfo) throws Exception;
	 ...
	 * @throws Exception that are thrown in the DAO layer
	 */
	public ResponseEntity<Object> deleteManufacturer(final Manufacturer manufacturer,final  UserInfo userInfo) throws Exception;
	 ...
	 * @throws Exception that are thrown in the DAO layer
	 */
	public ResponseEntity<Object> createSiteAddress(final ManufacturerSiteAddress manufacturerSite,final  UserInfo userInfo)
			throws Exception;
	 ...
	 * @throws Exception that are thrown in the DAO layer
	 */
	public ResponseEntity<Object> updateSiteAddress(final ManufacturerSiteAddress manufacturerSite,final  UserInfo userInfo)
			throws Exception;
	 ...
	 * @throws Exception that are thrown in the DAO layer
	 */
	public ResponseEntity<Object> deleteSiteAddress(final ManufacturerSiteAddress manufacturerSite,final  UserInfo userInfo)
			throws Exception;
	 ...
	 * @throws Exception that are thrown in the DAO layer
	 */
	public ResponseEntity<Object> createContactInfo(final ManufacturerContactInfo manufacturerContact,final  UserInfo userInfo)
			throws Exception;
	 ...
	 * @throws Exception that are thrown in the DAO layer
	 */
	public ResponseEntity<Object> updateContactInfo(final ManufacturerContactInfo manufacturerContact,final  UserInfo userInfo)
			throws Exception;
	 ...
	 * @throws Exception that are thrown in the DAO layer
	 */
	public ResponseEntity<Object> deleteContactInfo(final ManufacturerContactInfo manufacturerContact,final  UserInfo userInfo)
			throws Exception;
