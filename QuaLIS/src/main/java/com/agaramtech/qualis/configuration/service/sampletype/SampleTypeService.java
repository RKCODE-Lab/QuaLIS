...
public interface SampleTypeService {
	...
	ResponseEntity<Object> deleteSampleType(SampleType objSite, UserInfo userInfo) throws Exception;
	ResponseEntity<Object> getActiveSampleTypeById(int nsampletypecode, UserInfo userInfo) throws Exception;
