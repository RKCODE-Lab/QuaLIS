...
public interface LimsElnSiteMappingDAO {

	/**
	 * This interface declaration is used to get all the available
	 * limsElnSiteMappings with respect to site
	 * 
	...
	/**
	 * This interface declaration is used to add a new entry to limsElnSiteMapping
	 * table.
	 * 
	...
	/**
	 * This interface declaration is used to get all the available limsUsers with
	 * respect to site
	 * 
	 * @param userInfo [UserInfo] holding logged in user details and nmasterSiteCode
	 *                 [int] primary key of site object for which the list is to be
	...
	/**
	 * This interface declaration is used to delete an entry in limsElnSiteMapping
	 * table.
	 * 
	...
	/**
	 * This interface declaration is used to retrieve active limsElnSiteMapping
	 * object based on the specified nlimsElnSiteMappingCode.
	 * 
	 ...
	 * @throws Exception that are thrown in the DAO layer
	 */
	LimsElnSiteMapping getActiveLimsElnSitemappingById(final int nreasoncode)
			throws Exception;

	/**
	 * This interface declaration is used to update entry in limsElnSiteMapping
	 * table.
	 * 
	 * @param objLimsElnSiteMapping [LimsElnSiteMapping] object holding details to
