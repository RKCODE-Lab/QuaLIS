...
public interface SampleProcessingDAO {

	/**
	 * This DAO interface declaration will access the DAO layer that is used to retrieve list of all active storagesampleprocessing for the logged in site.
	 ...
	 */	
	ResponseEntity<Object> getSampleProcessing(final String fromDate, String toDate, String currentUIDate,
	...
	/**
	 * This DAO interface declaration will access the DAO layer that is used to retrieve list of all active Collection Tube Type data  for the specified project type and  site.
	 ...
	 * @throws Exception that are thrown from this DAO layer
	 */
	ResponseEntity<Object> getCollectionTubeType(final Map<String, Object> inputMap, UserInfo userInfo)
			throws Exception;
	/**
	 * This DAO interface declaration will access the DAO layer that is used to retrieve list of all active Sample Type data  for the specified project type and  site.
	 * @param inputMap  [inputMap] map object with "nprojecttypecode" and "userinfo" as keys for which the data is to be fetched
	 ...
	 * @throws Exception that are thrown from this DAO layer
	 */
	ResponseEntity<Object> getSampleType(final Map<String, Object> inputMap, UserInfo userInfo) throws Exception;

	/**
	 * This DAO interface declaration will access the DAO layer that is used to retrieve list of all active Sample Process Type data  for the specified project type and  site.
	 * @param inputMap  [inputMap] map object with "nprojecttypecode" and "userinfo" as keys for which the data is to be fetched
	 ...
	 * @throws Exception that are thrown from this DAO layer
	 */
	ResponseEntity<Object> getSampleProcessType(final Map<String, Object> inputMap, UserInfo userInfo) throws Exception;

	/**
	 * This DAO interface declaration will access the DAO layer that is used to retrieve list of all active Process Duration data  for the specified project type and Sample Type and Collection tube type and site.
	 ...
	 * @throws Exception that are thrown from this DAO layer
	 */
	ResponseEntity<Object> getProcessduration(final Map<String, Object> inputMap, UserInfo userInfo) throws Exception;

	/**
	 * This DAO interface declaration will access the DAO layer that is used to add a new entry to storagesampleprocessing  table.
	 ...
	 */
	ResponseEntity<Object> createSampleProcessing(final Map<String, Object> inputMap, UserInfo userInfo)
			throws Exception;

	/**
	 * This DAO interface declaration will access the DAO layer that is used to update entry in storagesampleprocessing details.
	 * @param inputMap  [inputMap] map object with "fromDate","toDate","currentdate","nprojecttypecode","temporarystorage" and "userinfo" as keys for which the data is to be fetched
	 * 								temporarystorage [TemporaryStorage]  object holding details to be added in temporarystorage table,
	 * 								userinfo [UserInfo] holding logged in user details	
	 ...
	 * @throws Exception exception
	 */
	ResponseEntity<Object> updateSampleProcessing(final Map<String, Object> inputMap, UserInfo userInfo)
			throws Exception;

	/**
	 * This DAO interface declaration will access the DAO layer that is used to retrieve a specific storagesampleprocessing record.
	 ...
	 * @throws Exception exception
	 */
	ResponseEntity<Object> getActiveSampleProcessingById(final Map<String, Object> inputMap, UserInfo userInfo)
			throws Exception;

	/**
	 * This DAO interface declaration will access the DAO layer that is used to delete an entry in storagesampleprocessing table
	 ...
	 * @throws Exception exception
	 */
	ResponseEntity<Object> deleteSampleProcessing(final Map<String, Object> inputMap, UserInfo userInfo)
			throws Exception;
}
