...
public interface SampleReceivingDAO {
	/**
	 * This interface declaration is used to get the over all samplereceivings with
	 * respect to site
	 * @param userInfo [UserInfo]
	 *  @param nprojecttypecode [int] primary key of samplereceiving object
	 * @return a response entity which holds the list of samplereceiving with
	 *         respect to site and also have the HTTP response code
	 * @throws Exception
	 */
	public ResponseEntity<Object> getSampleReceiving(final String fromDate, String toDate, String currentUIDate,
	 ...
	 */
	public ResponseEntity<Object> getBarcodeConfigData(final Map<String, Object> inputMap, UserInfo userInfo)
			throws Exception;
	 ...
	 */
	public ResponseEntity<Object> createSampleReceiving(final Map<String, Object> inputMap, UserInfo userInfo)
			throws Exception;
	 ...
	 * @throws Exception that are thrown in the DAO layer
	 */
	public ResponseEntity<Object> getActiveSampleReceivingById(final Map<String, Object> inputMap, UserInfo userInfo)
			throws Exception;
	...
	public ResponseEntity<Object> updateSampleReceiving(final Map<String, Object> inputMap, UserInfo userInfo)
			throws Exception;
	 ...
	 * @throws Exception that are thrown in the DAO layer
	 */
	public ResponseEntity<Object> deleteSampleReceiving(final Map<String, Object> inputMap, UserInfo userInfo)
			throws Exception;
