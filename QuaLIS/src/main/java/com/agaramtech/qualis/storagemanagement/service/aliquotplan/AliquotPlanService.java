...
/**
 * This interface declaration holds methods to perform CRUD operation on 'aliquotplan' table
 * @author ATE234
 * @version 9.0.0.1
 * @since   28- June- 2024
 */
public interface AliquotPlanService {
	 ...
	 * @param objprocesstype [aliquotplan] object holding details to be added in aliquotplan table
