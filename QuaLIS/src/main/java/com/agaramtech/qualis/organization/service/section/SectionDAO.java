...
/**
 * This interface holds declarations to perform CRUD operation on 'section' table
 */
public interface SectionDAO {
	 ...
	 * @throws Exception that are thrown in the DAO layer
	 */
	public Section getActiveSectionById(final int nsectionCode,UserInfo userInfo) throws Exception ;
