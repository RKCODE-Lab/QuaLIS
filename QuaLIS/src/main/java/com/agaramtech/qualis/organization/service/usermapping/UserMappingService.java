...
public interface UserMappingService {
	 ...
	 * @throws Exception thrown from UserMappingDAOImpl
	 */
	public ResponseEntity<Object> getChildUsers(final int lastParentUsercode,final int nroleCode,final int nSiteCode,final int nVersionCode,final int levelno) throws Exception;
	...
	public ResponseEntity<Object> copyUserMapping(final Map<String, Object> inputMap) throws Exception;
