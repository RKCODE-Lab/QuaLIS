...
/**
 * This interface holds declarations to perform CRUD operation on Lab table
 */
public interface LabDAO {

	/**
	 * This interface declaration is used to get all the available Labs with respect
	 * to site
	 * 
	...
	/**
	 * This interface declaration is used to add a new entry to Lab table.
	 * 
	...
	/**
	 * This interface declaration is used to update entry in Lab table.
	 * 
	...
	/**
	 * This interface declaration is used to retrieve active Lab object based on the
	 * specified nLabCode.
	 * 
	...
	/**
	 * This interface declaration is used to delete an entry in Lab table.
	 * 
