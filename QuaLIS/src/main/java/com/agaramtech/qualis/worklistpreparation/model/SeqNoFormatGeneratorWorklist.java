...
@Entity
@Table(name = "seqnoformatgeneratorworklist")
@Data
@NoArgsConstructor
@AllArgsConstructor
@EqualsAndHashCode(callSuper = false)
public class SeqNoFormatGeneratorWorklist extends CustomizedResultsetRowMapper<SeqNoFormatGeneratorWorklist> implements Serializable,RowMapper<SeqNoFormatGeneratorWorklist> {
	...
	@Override
	public SeqNoFormatGeneratorWorklist mapRow(ResultSet arg0, int arg1) throws SQLException {
		final SeqNoFormatGeneratorWorklist objseq = new SeqNoFormatGeneratorWorklist();	
