...
public interface TrainingCertificateService {
	...
	public ResponseEntity<Object> getActiveTrainingParticipantsById(final int nparticipantcode, final UserInfo userInfo)
			throws Exception;
...
//	public ResponseEntity<Object> inviteTrainingParticipants(TrainingParticipants trainingparticipants, UserInfo userInfo) throws Exception;
	...
	// public ResponseEntity<Object> cancelTrainingParticipants(TrainingParticipants
	// TrainingParticipants, UserInfo userInfo) throws Exception;
