 ...
 * 'containertype' table through its DAO layer.
 * 
 * @author ATE180
 * @version 9.0.0.1
 * @since 29- Jun- 2020
...
public interface ContainerTypeService {
	 ...
	 * containertype for the specified site through its DAO layer
	 * 
	 ...
	 * based on the specified ncontainertypecode through its DAO layer.
	 * 
