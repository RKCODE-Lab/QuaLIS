 ...
 */
public interface SamplePunchSiteService {
	/**
	 ...
	 */
	public ResponseEntity<Object> getSamplePunchSite(final UserInfo userInfo) throws Exception;
	 ...
	 * @throws Exception that are thrown in the DAO layer
	 */
	public ResponseEntity<Object> createSamplePunchSite(final SamplePunchSite samplePunchSite, UserInfo userInfo)
			throws Exception;

	/**
	 * This service interface declaration will access the DAO layer that is used to retrieve active samplepunchsite object based
	 ...
	 * @throws Exception that are thrown in the DAO layer
	 */
	public ResponseEntity<Object> getActiveSamplePunchSiteById(final int nsamplepunchsitecode, UserInfo userInfo)
			throws Exception;
	 ...
	 * @throws Exception that are thrown in the DAO layer
	 */
	public ResponseEntity<Object> updateSamplePunchSite(final SamplePunchSite samplePunchSite, UserInfo userInfo)
			throws Exception;

	/**
	 * This service interface declaration will access the DAO layer that is used to delete an entry in samplepunchsite  table.
	 ...
	 * @throws Exception that are thrown in the DAO layer
	 */
	public ResponseEntity<Object> deleteSamplePunchSite(final SamplePunchSite samplePunchSite, UserInfo userInfo)
			throws Exception;
}
