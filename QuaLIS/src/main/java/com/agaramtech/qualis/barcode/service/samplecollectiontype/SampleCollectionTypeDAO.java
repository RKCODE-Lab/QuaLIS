 ...
 */
public interface SampleCollectionTypeDAO {
	/**
	 ...
	 * object based on the specified nsamplecollectiontypecode.
	 * 
	 ...
	 */
	public SampleCollectionType getActiveSampleCollectionTypeById(final int nsamplecollectiontypecode,final
