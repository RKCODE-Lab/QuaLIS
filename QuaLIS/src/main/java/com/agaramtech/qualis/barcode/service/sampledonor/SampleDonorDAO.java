...
/**
 * This interface holds declarations to perform CRUD operation on 'sampledonor'
 * table
 * 
 * @author ATE236
 * @version 10.0.0.2
 */
public interface SampleDonorDAO {

	/**
	 * This interface declaration is used to get all the available sampledonor's with respect to site
	...
	/**
	 * This interface declaration is used to retrieve active sampledonor object based
	...
	/**
	 * This interface declaration is used to add a new entry to sampledonor table.
	...
	/**
	 * This interface declaration is used to update entry in sampledonor table.
	...
	/**
	 * This interface declaration is used to delete an entry in sampledonor table.
