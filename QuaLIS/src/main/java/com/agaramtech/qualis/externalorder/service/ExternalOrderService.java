...
public interface ExternalOrderService {
		...
		ResponseEntity<Object> outSourceSampleTest(final RegistrationTest testInput,final RegistrationTest otherdetails,final List<RegistrationTest> listTest, final int destinationSitecode, final int designTemplateMappingCode,
