 ...
 * @since 09-04-2025
 */
public interface DynamicPreRegDesignService {
	/**
	...
	public ResponseEntity<Object> getRegistrationTemplate(Map<String, Object> inputMap, UserInfo userInfo) throws Exception;
	
	public ResponseEntity<Object> getRegistrationTemplateById(int nreactregtemplatecode, UserInfo userInfo) throws Exception; 
	
	public ResponseEntity<Object> createRegistrationTemplate(ReactRegistrationTemplate regTemplate, UserInfo userInfo) throws Exception;
	
	public ResponseEntity<Object> updateRegistrationTemplate(ReactRegistrationTemplate regTemplate, UserInfo userInfo) throws Exception;
	
	public ResponseEntity<Object> deleteRegistrationTemplate(int nreactRegTemplateCode, UserInfo userInfo) throws Exception;
	
	public ResponseEntity<Object> approveRegistrationTemplate(Map<String, Object> inputMap, UserInfo userInfo) throws Exception;
	
	public ResponseEntity<Object> copyRegistrationTemplate(ReactRegistrationTemplate regTemplate, UserInfo userInfo) throws Exception;
