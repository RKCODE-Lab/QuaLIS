...
public interface RegistrationSubTypeService {

	public ResponseEntity<Object> getRegistrationSubTypeInitial(final UserInfo userInfo) throws Exception;

	public ResponseEntity<Object> getRegistrationSubType(final int regTypeCode,final UserInfo userInfo, final int regSubTypeCode) throws Exception;
	...
	public ResponseEntity<Object> getEditRegSubType(final short regSubTypeCode, final UserInfo userInfo)throws Exception ;

	public ResponseEntity<Object> getVersionDetails(final int regSubTypeConfigCode, final UserInfo userInfo)throws Exception ;

	public ResponseEntity<Object> getVersionDetailsByRelease(final int regSubTypeConfigCode, final UserInfo userInfo)throws Exception ;
