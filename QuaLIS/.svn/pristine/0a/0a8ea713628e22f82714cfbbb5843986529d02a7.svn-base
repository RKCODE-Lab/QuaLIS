...
public interface TestMasterDAO {
	...
	/**
	 * This method declaration is used to fetch a test data based on site. 
	 * @param userInfo [UserInfo] holds the loggedin user info
	 * @return response entity holds the map object of filtertestcategory, testmaster, selectedtest, testparameter and parameter details. 
	 * if the parameter type is numeric then the map holds testformula and testnumericparameter
	 * if the parameter type is predefined then the map holds codedresult
	 */
	 ...
	 * If nFlag = 1, to retrieve a active test section
	 * If nFlag = 2, to retrieve a active test method
	 * If nFlag = 3, to retrieve a active test instrument category
	 * If nFlag = 4, to retrieve a active test file
	 * If nFlag = 3, to retrieve a active test parameter and it's details (test formula, test parameter numeric, test predefined parameter)
	...
	/**
	 * This method declaration is used to fetch a list of parameter, and its parameter details, selectedtest
	 ...
	 * @param testMaster [TestMaster] holds the details of testmaster
	 * @param userInfo [UserInfo] holds the object of loggedin userinfo
	 * @param objTestParameter [TestParameter] holds the details of testparameter
	 * @param testSection [TestSection] holds the details of testsection
	 ...
	 * @throws Exception
	 */
	public ResponseEntity<Object> createTestMaster(final TestMaster testMaster, final UserInfo userInfo, final TestParameter objTestParameter, 
			final TestSection testSection, final TestMethod testMethod, final TestInstrumentCategory testInstCat,TestPackageTest objTestpackage,final int isQualisLite) throws Exception;
	 ...
	 * @throws Exception
	 */
	public ResponseEntity<Object> updateTestMaster(final TestMaster testMaster, final UserInfo userInfo,
	 ...
	 * @throws Exception
	 */
	public ResponseEntity<Object> deleteTestMaster(final TestMaster testMaster, final UserInfo userInfo,final int isQualisLite) throws Exception;
	 ...
	 * @throws Exception
	 */
	public ResponseEntity<Object> getAvailableSection(final TestMaster testMaster, final UserInfo userInfo) throws Exception;
	 ...
	 * @param testSection [TestSection] holds the details of test section
	 * @param userInfo [UserInfo] holds the object of loggedin userinfo
	 * @return response entity holds the list of testsection
	 * @throws Exception
	 */
	public ResponseEntity<Object> deleteTestSection(final TestSection testSection, final UserInfo userInfo,final int isQualisLite) throws Exception;
	 ...
	 * @throws Exception
	 */
	public ResponseEntity<Object> getAvailableMethod(final TestMaster testMaster, final UserInfo userInfo) throws Exception;
	 ...
	 * @throws Exception
	 */
	public ResponseEntity<Object> getAvailableInstrumentCategory(final TestMaster testMaster, final UserInfo userInfo) throws Exception;
	
	
	public ResponseEntity<Object> getAvailablePackage(final TestMaster testMaster, final UserInfo userInfo) throws Exception;
	/**
	...
	public Map<String, Object> getSeqNoToCopyTestMaser(final TestMaster testMaster, final UserInfo userInfo,final int isQualisLite) throws Exception;
	
	/**
	 * This method declaration is used to copy the test details for entered test
	 * @param testMaster [TestMaster] object holds the test details
	 ...
	 * @throws Exception
	 */
	public ResponseEntity<Object> copyTestMaster(final TestMaster testMaster, final UserInfo userInfo, Map<String, Object> inputMap) throws Exception;
	
	/**
	 * This method declaration is used to set a default test section
	 * @param testSection [TestSection] object holds the details for test section to set default
	 * @param userInfo [UserInfo] object holds the loggedin user info
	 * @return response entity of 'testsection' entity
	 * @throws Exception
	 */
	public ResponseEntity<Object> setDefaultTestSection(final TestSection testSection, final UserInfo userInfo,final int isQualisLite) throws Exception;
	...
	public ResponseEntity<Object> getAvailableContainerType(final TestMaster testMaster, final UserInfo userInfo) throws Exception;
	...
	//ALPD-3510
	public ResponseEntity<Object> setDefaultTestContainerType(final TestContainerType testContainerType, final UserInfo userInfo,final int isQualisLite) throws Exception;
   ...
   // public ResponseEntity<Object> getTestContainterType(final int ntestcode, final UserInfo userInfo) throws Exception;
	public TestContainerType getActiveTestContainerTypeById(final int ntestcontainertypecode,final UserInfo userInfo) throws Exception;
	...
	public ResponseEntity<Object> updateReportInfoTest(ReportInfoTest reportInfoTest,UserInfo userInfo) throws Exception;
