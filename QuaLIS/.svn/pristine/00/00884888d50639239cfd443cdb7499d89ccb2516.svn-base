...
/**
 * This interface holds methods to perform CRUD operation  on userrolesscreen and userrolescreencontrol
...
public interface ControlDAO {
	 ...
	 * specified site.
	 * @param nuserrolescreencode [int] primary key of userrolescreen object for which the list is to be fetched
	 * @param userInfo object is used for fetched the list of active records based on site.
	 * @return a response entity which holds the list of screenrights with respect to site and also have the HTTP response code 
	   * @throws Exception that are thrown from this DAO layer 
	 */
	ResponseEntity<Object> getControlRights(UserInfo userInfo, Integer nuserrolescreencode) throws Exception;
	/**
	...
	/**
	 *  This method is used to retrieve nseqno  from this table seqnocredentialmanagement  for  userrolescreen and userrolescreencontrol
	 * @param inputMap  [Map] map object added into nuserrolecontrolcode seqno.
	 * @return a response entity which holds the list of screenrights with respect to site and also have the HTTP response code 
	  * @throws Exception that are thrown from this DAO layer
	 */
	Map<String, Object> getControlRightsSeqno(Map<String, Object> inputMap) throws Exception;
