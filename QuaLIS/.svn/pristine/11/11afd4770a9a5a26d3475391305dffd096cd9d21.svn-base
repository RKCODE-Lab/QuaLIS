...
/**
 * This interface holds declarations to perform CRUD operation on 'testpackage' table
 */

public interface TestPackageDAO {
	
	/**
	 * This interface declaration is used to get all the available testpackage with respect to site
	...
	/**
	 * This interface declaration is used to add a new entry to testpackage  table.
	...
	/**
	 * This interface declaration is used to delete an entry in testpackage  table.
	...
	/**
	 * This interface declaration is used to retrieve active testpackage object based
	 ...
	 * @throws Exception that are thrown in the DAO layer
	 */
	public TestPackage getActiveTestPackageById(final int npackagecode,final UserInfo userInfo) throws Exception;
	
	/**
	 * This interface declaration is used to update entry in testpackage  table.
