...
public interface BulkBarcodeConfigDAO {
	...
	/**
	 * This DAO interface declaration will access the DAO layer that is used to retrieve a list of all active barcodemaster entries.
	...
	/**
	 * This DAO interface declaration will access the DAO layer that is used to make a new entry to bulkbarcodeconfig  table.
	...
	/**
	 * This DAO interface declaration will access the DAO layer that is used to update selected bulkbarcodeconfig details.
	 * @param inputMap  [inputMap] map object with "bulkbarcodeconfig" and "userinfo" as keys for which the data is to be fetched
	 * 								bulkbarcodeconfig [BulkBarcodeConfig]  object holding details to be added in bulkbarcodeconfig table,
	 * 								userinfo [UserInfo] holding logged in user details
	...
	/**
	 * This DAO interface declaration will access the DAO layer that is used to delete an entry in bulkbarcodeconfig table
	 * @param inputMap  [inputMap] map object with "bulkbarcodeconfig" and "userinfo" as keys for which the data is to be fetched	
	...
	/**
	 * This DAO interface declaration will access the DAO layer that is used to retrieve a specific bulkbarcodeconfig record.
	 ...
	 * @throws Exception exception
	 */
	public BulkBarcodeConfig getActiveBulkBarcodeConfigurationById(final int nbulkbarcodeconfigcode, UserInfo userInfo)
			throws Exception;

	/**
	 * This DAO interface declaration will access the DAO layer that is used to update selected bulkbarcodeconfigversion table.
	...
	/**
	 * This DAO interface declaration will access the DAO layer that is used to retrieve a list of all active barcodemaster entries for the selected project type.
	...
	/**
	 * This DAO interface declaration will access the DAO layer that will is used to make a new entry to bulkbarcodeconfigdetails  table for the selected bulkbarcodeconfig.
	...
	/**
	 * This DAO interface declaration will access the DAO layer that is used to update selected bulkbarcodeconfigdetails details.
	 * @param inputMap  [inputMap] map object with "bulkbarcodeconfigdetails" and "userinfo" as keys for which the data is to be fetched
	...
	/**
	 * This DAO interface declaration will access the DAO layer that is used to delete an entry in bulkbarcodeconfigdetails table
	 * @param inputMap  [inputMap] map object with "bulkbarcodeconfigdetails" and "userinfo" as keys for which the data is to be fetched
	...
	/**
	 * This DAO interface declaration will access the DAO layer that is used to retrieve a specific bulkbarcodeconfigdetails record.
	...
	/**
	 * This DAO interface declaration will access the DAO layer that is used to retrieve a list of all active ParentBarcodeDetails entries for the selected project type and Bulk Barcode Config.
	 * @param inputMap  [Map] map object with "nprojecttypecode","nbulkbarcodeconfigcode" and "userinfo" as keys for which the data is to be fetched
	 * @return ResponseEntity object containing the response status and a map of key-value pairs,
