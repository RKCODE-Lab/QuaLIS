...
@Entity
@Table(name = "seqnostability")
@Data
@NoArgsConstructor
@AllArgsConstructor
@EqualsAndHashCode(callSuper = false)
public class SeqNoStability extends CustomizedResultsetRowMapper<SeqNoStability> implements Serializable,RowMapper<SeqNoStability>{
	...
	public SeqNoStability mapRow(ResultSet arg0, int arg1) throws SQLException {
		SeqNoStability objseq = new SeqNoStability();
