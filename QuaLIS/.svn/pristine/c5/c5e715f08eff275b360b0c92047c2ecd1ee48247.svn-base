...
public interface GoodsInDAO {
	...
	public ResponseEntity<Object> getApprovedVersionTemplateMapping(Map<String, Object> inputMap,final UserInfo userInfo) throws Exception;
	...
	public ResponseEntity<Object> getGoodsInSampleDetails(final int ngoodsincode,final int ndesigntemplatemappingcode,UserInfo userInfo)throws Exception;
	...
	public GoodsInSample getActiveGoodsInSampleById(final int ngoodsinsamplecode,UserInfo userInfo) throws Exception ;
	...
	public List<Map<String, Object>> getGoodsInSampleAuditGet(final int ngoodsinsamplecode,final int ngoodsincode,final int ndesigntemplatemappingcode,UserInfo userInfo)throws Exception;
