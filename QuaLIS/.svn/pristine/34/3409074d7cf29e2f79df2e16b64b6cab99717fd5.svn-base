...
/**
 * This interface declaration holds methods to perform CRUD operation on 'temporarystorage' table
 */
public interface TemporaryStorageService {
	 ...
	 */
	ResponseEntity<Object> getTemporaryStorage(String fromDate, String toDate, String currentUIDate, UserInfo userInfo,
	...
	/**
	 * This service interface declaration will access the DAO layer that is used to add a new entry to temporarystorage  table.
	 ...
	 * @throws Exception that are thrown in the DAO layer
	 */
	ResponseEntity<Object> createTemporaryStorage(final Map<String, Object> inputMap, final UserInfo userInfo)
			throws Exception;

	/**
	 * This service interface declaration will access the DAO layer that is used to retrieve active temporarystorage table.
	 ...
	 * @throws Exception that are thrown in the DAO layer
	 */
	ResponseEntity<Object> getActiveTemporaryStorageById(final Map<String, Object> inputMap, final UserInfo userInfo)
			throws Exception;

	/**
	 * This service interface declaration will access the DAO layer that is used to update entry in temporarystorage  table.
	 * @param inputMap  [Map] map object with "nprojecttypecode","ntemporarystoragecode" and "userInfo" as keys for which the data is to be fetched
	 * @return response entity object holding response status and data of updated temporarystorage object
	 * @throws Exception that are thrown in the DAO layer
	 */
	ResponseEntity<Object> updateTemporaryStorage(final Map<String, Object> inputMap, final UserInfo userInfo)
			throws Exception;

	/**
	 * This service interface declaration will access the DAO layer that is used to delete an entry in temporarystorage  table.
	 * @param inputMap  [inputMap] map object with "fromDate","toDate","currentdate","nprojecttypecode","temporarystorage" and "userinfo" as keys for which the data is to be fetched
	 * 								temporarystorage [TemporaryStorage]  object holding details to be added in temporarystorage table,
	 * 								userinfo [UserInfo] holding logged in user details.
	 ...
	 * @throws Exception that are thrown in the DAO layer
	 */
	ResponseEntity<Object> deleteTemporaryStorage(final Map<String, Object> inputMap, final UserInfo userInfo)
			throws Exception;
