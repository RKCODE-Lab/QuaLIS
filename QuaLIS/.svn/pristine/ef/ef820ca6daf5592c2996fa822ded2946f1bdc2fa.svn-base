...
/**
 * This interface holds declarations to perform CRUD operation on 'quotation' table
...
public interface QuotationDAO {
	...
	/**
	 * This interface declaration is used to approve the quotation table.
	...
	/**
	 * This interface declaration is used to get the over all quotationtest with respect to nquotationcode
	 * @param userInfo [UserInfo]
	 * @return a response entity which holds the list of quotationtest with respect to nquotationcode and also have the HTTP response code 
	 * @throws Exception
	 */
	...
	/**
	 * This interface declaration is used to get the over all quotationprice with respect to nquotationtestcode and nquotationcode
	 * @param userInfo [UserInfo]
	 * @return a response entity which holds the list of quotationprice with respect to nquotationtestcode and nquotationcode and also have the HTTP response code 
	 * @throws Exception
	 */
	public ResponseEntity<Object> getQuotationPrice(int nquotationtestcode, Integer nquotationcode, UserInfo userInfo) throws Exception;
	 ...
	 * @throws Exception that are thrown in the DAO layer
	 */
	public ResponseEntity<Object> updateQuotationTest(List<QuotationTest> quotationTestList, int nquotationtestcode,
			UserInfo userInfo) throws Exception;

	/**
	 * This interface declaration is used to get the over all quotationgrossamount with respect to nquotationcode
	 * @param userInfo [UserInfo]
	 * @return a response entity which holds the list of quotationgrossamount with respect to nquotationcode and also have the HTTP response code 
	 * @throws Exception
	 */
	 ...
	 * @param objGrossQuotation [GrossQuotation] object holding details to be added in quotationtotalamount table
	...
	/**
	 * This interface declaration is used to get the over all grossquotation with respect to nquotationcode
	 * @param userInfo [UserInfo]
	 * @return a response entity which holds the list of grossquotation with respect to nquotationcode and also have the HTTP response code 
	 * @throws Exception
	 */
	...
	/**
	 * This interface declaration is used to get the over all product with respect to nproductcatcode
	 * @param userInfo [UserInfo]
	 * @return a response entity which holds the list of product with respect to nproductcatcode and also have the HTTP response code 
	 * @throws Exception
	 */
	...
	/**
	 * This interface declaration is used to retire the quotation table.
	 * @param quotation [Quotation] object holding detail to be retire in quotation table
