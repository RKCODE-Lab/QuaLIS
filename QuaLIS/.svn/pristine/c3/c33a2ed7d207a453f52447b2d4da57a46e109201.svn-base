...
public interface MaterialService {
	...
	public ResponseEntity<Object> getMaterialType(final UserInfo userInfo, final String currentUIDate) throws Exception;
	...
	public ResponseEntity<Object> createMaterialMsdsAttachment(MultipartHttpServletRequest request,
			final UserInfo objUserInfo) throws Exception;

	public ResponseEntity<Object> editMaterialMsdsAttachment(final Map<String, Object> inputMap,
			final UserInfo objUserInfo) throws Exception;

	public ResponseEntity<Object> updateMaterialMsdsAttachment(MultipartHttpServletRequest request,
			final UserInfo objUserInfo) throws Exception;
