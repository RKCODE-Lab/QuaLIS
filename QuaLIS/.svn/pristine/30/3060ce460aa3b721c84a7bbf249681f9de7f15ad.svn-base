...
/**
 * This interface holds declarations to perform CRUD operation on 'settings'
 * table
 * 
 * @author ATE241
 */
public interface SettingsDAO {
	...
	/**
	 * This interface declaration is used to retrieve active settings object based
	 * on the specified nsettingsCode.
	 * 
	 * @param nsettingsCode [int] primary key of settings object
	 * @return response entity object holding response status and data of settings
	 *         object
	 * @throws Exception that are thrown in the DAO layer
	 */
	public ResponseEntity<Object> getActiveSettingsById(final int nsettingsCode, UserInfo userInfo) throws Exception;
