...
public interface StabilityStudyPlanDAO {
	public ResponseEntity<Object> getStabilityStudyPlan(final UserInfo userInfo, final String currentUIDate)
			throws Exception;

	public ResponseEntity<Object> createSample(final Map<String, Object> inputMap) throws Exception;
	...
	public ResponseEntity<Object> createTest(final UserInfo userInfo, final List<String> listSample,
			final List<TestGroupTest> listTest, final int nregsubtypecode, final int nregtypecode,
			final Map<String, Object> inputMap) throws Exception;

	public Map<String, Object> validateSeqnoSubSampleNo(final Map<String, Object> inputMap) throws Exception;

	public Map<String, Object> createTimePoint(final Map<String, Object> inputMap) throws Exception;
