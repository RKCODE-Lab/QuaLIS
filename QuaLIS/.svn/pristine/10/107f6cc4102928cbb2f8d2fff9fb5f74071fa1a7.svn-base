...
public interface TestGroupParameterDAO {
	...
	public Map<String, Object> getUpdateSequenceParameter(final UserInfo objUserInfo,
	...
	public ResponseEntity<Object> createTestGroupAddSpecification(final UserInfo objUserInfo,
			final TestGroupTestClinicalSpec objClinicalSpec, final TestGroupSpecification objGroupSpecification)
			throws Exception;
