...
//
//import com.agaramtech.exceptionhandle.ExceptionHandleDAO;
...
//
//public class SchedularExceptionLogsDAOImpl extends ProjectDAOSupport implements SchedularExceptionLogsDAO {
//	@Autowired
//	ExceptionHandleDAO exceptionHandleDAO;
//	private AgaramtechGeneralfunction objGeneral;
//	private static int dataBaseType = 0;
//
//	Logger logger = LoggerFactory.getLogger(this.getClass());
//
//	public SchedularExceptionLogsDAOImpl(RDBMSParameter objParameter, AgaramtechGeneralfunction objGeneral,
...
//	}
//	// Three months once delete exception logs  by using scheduler  --ALPD-4159 ,work done by Dhanushya R I
...
//		exceptionHandleDAO.deleteExceptionLogs();
//		}
//		catch(Exception e)
//		{
