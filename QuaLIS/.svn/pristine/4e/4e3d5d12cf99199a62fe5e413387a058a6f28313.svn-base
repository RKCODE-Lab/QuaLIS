...
public interface StaticDashBoardDAO {
	public ResponseEntity<Map<String,Object>> getStaticDashBoard(com.agaramtech.qualis.global.UserInfo userInfo,
			final int nstaticDashBoardCode, final int nstaticDashBoardMasterCode, Map<String, Object> sparamValue)
			throws Exception;
