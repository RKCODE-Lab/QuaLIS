...
public interface DepartmentLabDAO {

	/**
	 * This interface declaration is used to update entry in DepartmentLab table.
	 * 
	 * @param objDepartmentLab [DepartmentLab] object holding details to be updated
	 *                         in DepartmentLab table
	...
	/**
	 * This interface declaration is used to get all the available DepartmentLabs
	...
	/**
	 * This interface declaration is used to delete an entry in DepartmentLab table.
	 * 
	 * @param objDepartmentLab [UnDepartmentLabit] object holding detail to be
	 *                         deleted from DepartmentLab table
	 * @param userInfo         [UserInfo] holding logged in user details and
	 *                         nmasterSiteCode [int] primary key of site object for
	 *                         which the list is to be fetched
	 * @return response entity object holding response status and data of deleted
	 *         DepartmentLabnit object
	 * @throws Exception that are thrown in the DAO layer
	 */
