...
public interface  TestParameterDAO {
	 ...
	 * @throws Exception
	 */
	public Map<String, Object> updateTestParameter(final TestParameter objTestParameter, final UserInfo objUserInfo,final int isQualisLite) throws Exception;
	
	/**
	 * This method declaration is used to fetch a testparameter and it's details
	 * @param objTestParameter [TestParameter] holds the details of testparameter
	 * @param objUserInfo [UserInfo] holds the object of loggedin userinfo
	 * @return response entity holds the list of testparameter and its parameter details
	 * @throws Exception
	 */
	public ResponseEntity<Object> getTestParameterAfterUpdate(final TestParameter objTestParameter, final UserInfo objUserInfo) throws Exception;
	...
	/**
	 * This method is used to fetch a parameter numeric specification using primaykey
	...
	/**
	 * This method declaration is used to set a default formula
	 ...
	 * @throws Exception
	 */
	public ResponseEntity<Object> setDefaultTestFormula(TestFormula objTestFormula, UserInfo objUserInfo,final int isQualisLite) throws Exception;
	
	/**
	 * This method declaration is used to set a default coded result
	 * @param objTestPredefinedParameter [TestPredefinedParameter] object holds the details to set default coded result
	 * @param objUserInfo [UserInfo] object holds the loggedin user info
