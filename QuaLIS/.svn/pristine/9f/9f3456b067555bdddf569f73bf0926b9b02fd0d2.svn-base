...
public interface SchedulerConfigurationService {
	public ResponseEntity<Object> getSchedulerConfiguration(Map<String, Object> inputMap, final UserInfo userInfo) throws Exception;

	public ResponseEntity<Object> getSampleType(Map<String, Object> inputMap, final UserInfo userInfo) throws Exception;

	public ResponseEntity<Object> getRegistrationType(int nSampleType, Map<String, Object> inputMap, final UserInfo userInfo) throws Exception;

	public ResponseEntity<Object> getRegistrationSubType(int nregTypeCode, Map<String, Object> inputMap, final UserInfo userInfo) throws Exception;

	public ResponseEntity<Object> getApprovalConfigVersion(int nregTypeCode, int nregSubTypeCode, Map<String, Object> inputMap, final UserInfo userInfo) throws Exception;

	public ResponseEntity<Object> getApproveConfigVersionRegTemplate(int nregTypeCode, int nregSubTypeCode, int napproveConfigVersionCode, Map<String, Object> inputMap, final UserInfo userInfo) throws Exception;

	public ResponseEntity<Object> getSchedulerConfigByFilterSubmit(Map<String, Object> inputMap, final UserInfo userInfo) throws Exception;

	public ResponseEntity<Object> createSchedulerConfig(Map<String, Object> inputMap, final UserInfo userInfo) throws Exception;

	public ResponseEntity<Object> getSchedulerConfigSubSample(Map<String, Object> inputMap, final UserInfo userInfo) throws Exception;

	public ResponseEntity<Object> getSchedulerConfigTest(Map<String, Object> inputMap, final UserInfo userInfo) throws Exception;

	public ResponseEntity<Object> getSchedulerConfigParameter(Map<String, Object> inputMap, final UserInfo userInfo) throws Exception;
	...
	public ResponseEntity<Object> createTest(Map<String, Object> inputMap, UserInfo userInfo) throws Exception;
