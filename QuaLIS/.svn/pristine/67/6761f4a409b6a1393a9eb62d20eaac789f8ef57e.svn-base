...
public interface BatchcreationService {
	...
	public ResponseEntity<Object> getSample(int inputMap,int nbatchmastercode,final UserInfo userInfo,int nregtypecode,
	...
	public ResponseEntity<Object> createSample(List<Batchsample> batchSampleList, 
			UserInfo userInfo,int ndesigntemplatemappingcode,int nregtypecode,int nregsubtypecode) throws Exception;
	public ResponseEntity<Object> getSampleTabDetails(int batchmastercode,final UserInfo userInfo,int ndesigntemplatemappingcode) throws Exception;
	...
	public ResponseEntity<Object> getMaterialAvailQtyBasedOnInv(int materialInvCode,int sectionCode,UserInfo userInfo,Map<String,Object> inputMap) throws Exception;
