...
public interface ReportMasterDAO {
	...
	public ReportDetails getActiveReportDetailById(final int reportDetailCode, final UserInfo userInfo)
			throws Exception;
	...
	public ResponseEntity<Object> createSubReportDetails(final MultipartHttpServletRequest request,
			final SubReportDetails reportDetails, final UserInfo userInfo) throws Exception;
