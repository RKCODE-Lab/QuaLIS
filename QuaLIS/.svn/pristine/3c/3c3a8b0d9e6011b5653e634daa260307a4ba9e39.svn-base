...
/**
 * This interface declaration holds methods to perform CRUD operation on 'unit' table
 */
public interface UnitService {
	...
	/**
	 * This service interface declaration will access the DAO layer that is used to retrieve active unit object based
	 ...
	 * @throws Exception that are thrown in the DAO layer
	 */
	public ResponseEntity<Object> getActiveUnitById(final int nunitCode,UserInfo userInfo) throws Exception ;
	...
	/**
	 * This service interface declaration will access the DAO layer that is used to delete an entry in unit  table.
